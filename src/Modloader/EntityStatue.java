...
//            EntityLiving, mod_statues, Item, World, 
//            DamageSource
...
public class EntityStatue extends EntityLiving
{
    ...
    {
        super(world);
        dropId = mod_WeepingAngel.statue.shiftedIndex;
        livingEntity = net.minecraft.src.EntityWeepingAngel.class;
        canBeActivated = true;
    ...
    public void onUpdate()
    {
        ...
        float f2 = 0.0F;
        field_9361_v = field_9361_v + (f2 - field_9361_v) * 0.3F;
        float f3;
